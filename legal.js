...
(function () {
  ...
  var COPYRIGHT = '&copy; כל הזכויות שמורות לאקודוס 2026';
  ...
  // ---- חלון אישור בכניסה ראשונה ----
  function showConsent() {
    if (localStorage.getItem(STORAGE_KEY) === '1') return;
    if (currentFile() === TERMS_URL) return; // לא מציגים כשקוראים את התקנון עצמו
    ...
    ov.innerHTML =
      '<div dir="rtl" style="background:#fff;max-width:440px;width:100%;border-radius:16px;box-shadow:0 18px 60px rgba(0,0,0,.3);padding:26px 24px;font-family:inherit;text-align:center;">' +
        ...
        '<h2 style="margin:0 0 10px;font-size:1.25rem;color:#1A2332;">ברוכים הבאים</h2>' +
        '<p style="margin:0 0 18px;color:#5A6C7D;font-size:.98rem;line-height:1.7;">השימוש באתר כפוף ל<a href="' + TERMS_URL + '" style="color:' + ACCENT + ';font-weight:600;">תקנון ותנאי השימוש</a> ול<a href="' + TERMS_URL + '#privacy" style="color:' + ACCENT + ';font-weight:600;">מדיניות הפרטיות</a>. לחיצה על "אני מאשר/ת" מהווה הסכמה לתנאים.</p>' +
        ...
        '<div style="margin-top:10px;"><a href="' + TERMS_URL + '" style="color:#8895ad;font-size:.85rem;">קריאת התקנון המלא ←</a></div>' +
      '</div>';
